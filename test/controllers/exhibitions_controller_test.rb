...
class ExhibitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exhibition" do
    assert_difference('Exhibition.count') do
      post exhibitions_url, params: { exhibition: { description: @exhibition.description, title: @exhibition.title } }
    end
  ...
  test "should update exhibition" do
    patch exhibition_url(@exhibition), params: { exhibition: { description: @exhibition.description, title: @exhibition.title } }
